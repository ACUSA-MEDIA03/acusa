...
<div className="p-4 sm:p-6 md:p-7.5 space-y-6 sm:space-y-9">
  ...
  <div className="space-y-4 sm:space-y-6">
    <div className="flex items-center justify-center flex-col text-center px-2">
      <h2 className="font-rubik font-extrabold text-xl sm:text-2xl md:text-[30px] leading-tight">
        {publication.title}
      </h2>
      
      {/* Author */}
      {(publication.author || publication.createdBy?.name) && (
        <p className="text-red-500 font-grotesk font-semibold text-sm sm:text-base mt-2">
    ...
    {publication.imageUrl && (
      <div className="w-full max-w-4xl mx-auto rounded-lg overflow-hidden my-4 sm:my-6">
        <Image
    ...
    {/* Main Content */}
    {publication.content && (
      <div className="font-grotesk leading-6 sm:leading-7.5 space-y-4">
        <div
    ...
    {publication.images && publication.images.length > 0 && (
      <div className="my-6 sm:my-8">
        <h3 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 font-rubik">
          Gallery
        </h3>
      ...
      <div className="pt-4 sm:pt-6 border-t border-gray-200">
        <div className="flex flex-wrap gap-2">
          {publication.tags.map((tag, index) => (
            <span
              key={index}
              className="bg-gray-100 text-gray-700 px-3 py-1 rounded-full text-xs sm:text-sm font-grotesk"
            >
              #{tag}
            </span>
          ))}
