                    ...
                    <div className="text-white space-y-4 w-full flex items-center flex-col text-center">
                        ...
                        <ul className="font-grotesk space-y-3">
                            <li className='flex items-center gap-2'>
                                <Link 
                                    className='border lg:border-[gray] hover:border-[#000000] hover:bg-[#000000] transition-all ease-in-out w-6 h-6 rounded-full grid place-content-center p-5' 
                                    target="_blank" 
                                ...
                                <Link 
                                    className='border lg:border-[gray] hover:border-[#25d366] hover:bg-[#25d366] transition-all ease-in-out w-6 h-6 rounded-full grid place-content-center p-5' 
                                    target="_blank" 
                                ...
                                <Link 
                                    className='border lg:border-[gray] hover:border-[#1da1f2] hover:bg-[#1da1f2] transition-all ease-in-out w-6 h-6 rounded-full grid place-content-center p-5'
                                    target="_blank" 
                                    href=""
                                > 
                                    <BsSnapchat/> 
                                ...
                                <Link 
                                    className='border lg:border-[gray] hover:border-[#c32aa3] hover:bg-[#c32aa3] transition-all ease-in-out w-6 h-6 rounded-full grid place-content-center p-5' 
                                    target="_blank" 
                                ...
                                <Link 
                                    className='border lg:border-[gray] hover:border-[#0a66c2] hover:bg-[#0a66c2] transition-all ease-in-out w-6 h-6 rounded-full grid place-content-center p-5' 
                                    target="_blank" 
                                    href=""
                                >
                                    <FaLinkedin  />
                                ...
                                <Link 
                                    className='border lg:border-[gray] hover:border-[#1ed760] hover:bg-[#1ed760] transition-all ease-in-out w-6 h-6 rounded-full grid place-content-center p-5'
                                    target="_blank" 
